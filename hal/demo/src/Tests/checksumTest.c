...
static unsigned int LUT_crc32[4][256];
...
Boolean checksumTest(void)
{
	...
	// Prepare LUTs
	checksum_prepareSlicedLUTCRC32(CRC32_POLYNOMIAL_REVERSED, LUT_crc32);
	...
	crc32_final = checksum_calculateSlicedCRC32LUT((unsigned char*)testdata, strlen(testdata), LUT_crc32, CRC32_DEFAULT_STARTREMAINDER);
	...
	crc32_intermediate = checksum_calculateSlicedCRC32LUT((unsigned char*)testdata, 10, LUT_crc32, CRC32_DEFAULT_STARTREMAINDER);
	crc32_final = checksum_calculateSlicedCRC32LUT((unsigned char*)testdata + 10, strlen(testdata) - 10, LUT_crc32, crc32_intermediate);
	...
	time_startcalc = xTaskGetTickCount();
	crc32_final = checksum_calculateSlicedCRC32LUT(bigdatablock, BIGDATABLOCKSIZE, LUT_crc32, CRC32_DEFAULT_STARTREMAINDER);
